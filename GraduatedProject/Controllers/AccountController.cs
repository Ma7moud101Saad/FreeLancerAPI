...
using GraduatedProject.Providers;
using GraduatedProject.Results;
...
namespace GraduatedProject.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public UserInfoViewModel GetUserInfo()
        {
            ...
            info.HasRegistered = externalLogin == null;
            info.LoginProvider = externalLogin != null ? externalLogin.LoginProvider : null;
            return info;
